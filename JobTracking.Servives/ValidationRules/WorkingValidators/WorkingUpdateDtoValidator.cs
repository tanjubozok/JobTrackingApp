...
namespace JobTracking.Services.ValidationRules.WorkingValidators;

public class WorkingUpdateDtoValidator : AbstractValidator<WorkingUpdateDto>
{
    public WorkingUpdateDtoValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage("İş alanı zorunludur");
