...
public class Response<T> : Response, IResponse<T>, IBaseEntity
{
    ...
    public Response(ResponseType responseType, List<CustomValidationError> customValidationErrors)
        : base(responseType)
    {
        this.CustomValidationErrors = customValidationErrors;
    }

    public Response(ResponseType responseType, T data, List<CustomValidationError> customValidationErrors)
        : base(responseType)
    {
        this.Data = data;
        this.CustomValidationErrors = customValidationErrors;
